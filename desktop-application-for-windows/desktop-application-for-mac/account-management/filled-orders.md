...
* Daily;
* Range – calls date menu 'From ... To' which allows to set up a desired time range. When the 'Range' period is set up, the icon![](../../../.gitbook/assets/1%20%289%29.png)appears allowing to change a time range for viewing filled orders.
