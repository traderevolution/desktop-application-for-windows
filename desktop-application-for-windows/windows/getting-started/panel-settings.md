...
* Show totals – allows showing total amount for columns. Be attentive to mark the "Show total" option as checked as well for selected columns in the Columns tab ![](../../../.gitbook/assets/2%20%2850%29.png). 
...
Click on the button![](../../../.gitbook/assets/5%20%2833%29.png)to add a new Color scheme. Its title can be changed directly from the title cell. Use the button![](../../../.gitbook/assets/6%20%2823%29.png)to activate or deactivate a color scheme. A color scheme can be also removed with the button![](../../../.gitbook/assets/7%20%2827%29.png).
