...
* D Call strike – is a Call strike, Delta absolute value of which is the closest to a Delta value in the settings![](../../../.gitbook/assets/screenshot_1%20%285%29.png); 
...
In order to hide the Chart settings menu, press the button![](../../../.gitbook/assets/screenshot_3%20%281%29.png), this will result into the chart’s maximization.
